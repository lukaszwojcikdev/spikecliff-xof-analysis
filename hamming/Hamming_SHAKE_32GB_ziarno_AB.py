...
if __name__ == "__main__":
    ...
    #   shake128_xof_32gb_ziarno_A.bin / _B.bin
    #   shake256_xof_32gb_ziarno_A.bin / _B.bin
    # -------------------------------------------------------

    pairs = [
        ("shake128_xof_32gb_ziarno_A.bin", "shake128_xof_32gb_ziarno_B.bin", "SHAKE128 XOF 32 GB (ziarno A vs B)"),
        ("shake256_xof_32gb_ziarno_A.bin", "shake256_xof_32gb_ziarno_B.bin", "SHAKE256 XOF 32 GB (ziarno A vs B)"),
    ]
    ...
    if results:
        save_results(results, "wyniki_Hamming_SHAKE_32GB_ziarno_AB.txt")
    else:
