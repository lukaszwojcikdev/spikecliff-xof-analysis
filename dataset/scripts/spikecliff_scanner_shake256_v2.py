"""
SpikeCliff Scanner — SHAKE256 Edition
"""
...
ALGORITHM = "SHAKE256"  # ← SHAKE256 (r=136)
OUTPUT_SIZE = 32
...
print(f"END_SIZE:    {END_SIZE}")
print(f"OUTPUT_FILE: {OUTPUT_FILE}")
print("=" * 80 + "\n")

# Poczekaj 2 sekundy żeby użytkownik zobaczył
time.sleep(2)
